...
| <a name="">GlobalStateSchema</a>| _optional_| <a >StateSchema</a>| `"apgs"`| Holds the maximum number of global state values defined within a <a >StateSchema</a> object.|
| <a name="">LocalStateSchema</a>| _optional_| <a >StateSchema</a>| `"apls"`| Holds the maximum number of local state values defined within a <a >StateSchema</a> object.|
